...
//
//    Input input1(Crypto::CommitBlinded(50, blind_a), Schnorr::Sign(blind_a.data(), InputMessage()));
//    Input input2(Crypto::CommitBlinded(25, blind_b), Schnorr::Sign(blind_b.data(), InputMessage()));
//    Input input3(Crypto::CommitBlinded(10, blind_c), Schnorr::Sign(blind_c.data(), InputMessage()));
//
