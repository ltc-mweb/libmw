...
TEST_CASE("Reorg Chain")
{
...

    {
        ...
        pNode->ValidateBlock(block1.GetBlock(), { block1_tx1.GetPegInCoin() }, {});
        ...
        pNode->ValidateBlock(block2.GetBlock(), { block2_tx1.GetPegInCoin() }, {});
        ...
        pNode->ValidateBlock(block3.GetBlock(), { block3_tx1.GetPegInCoin() }, {});
